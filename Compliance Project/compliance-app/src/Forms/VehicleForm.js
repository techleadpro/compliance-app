...
import VehicleDashboard from "../Forms-interface/vehicle-interface";
...
export default function VehicleFormModal() {
  ...
  {sections.map((label, index) => {
          ...
          {label}
            ...
            {currentSection === 0 && (
              <div className="grid grid-cols-2 gap-4 mb-6">
                <input placeholder="Vehicle id/number" className="border p-2 rounded" />
                <input placeholder="Car model" className="border p-2 rounded" />
            ...
            {currentSection === 1 && (
              <CanteenForm value="tank">
                <AccordianItem value="tank" trigger="Vehicle Inspection">
                  <ChecklistSection
                    items={[
                               "Exterior Body (no damage, clean)",
    "Tires (tread depth, pressure, damage)",
    "Wheels/Rims (no cracks or missing nuts)",
    ...
    "Windows (up/down, clean)",
    "Doors (open/close, locks)",
                ...
                <AccordianItem value="safety" trigger="Vehicle Safety & Functionality">
                  <ChecklistSection
                    items={[
                       "Seatbelts (all functioning)",
    "Steering Functionality",
    "Brakes (incl. handbrake)",
    "Engine Oil Level",
    "Coolant Level",
    "Battery Condition (visual check)",
    "Fuel Level",
