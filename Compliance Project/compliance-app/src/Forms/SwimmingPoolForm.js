...
export default function SwimmingPoolFormModal() {
      ...
      <div key={index} className="flex flex-col items-center text-center flex-1 ">
        ...
        >
          {label}
            ...
            {currentSection === 1 && (
              <CanteenForm value="poolsafety">
                <AccordianItem value="poolsaftey" trigger="Pool Safety & Structure">
                  <ChecklistSection
                    items={[
                      "Pool area is clean and free of debris",
                      "Pool deck is clear of obstructions",
                      "Lifeguard stations are organized",
                      "First aid kit stocked and accessible",
                      "Emergency equipment in place (e.g., rescue tubes, backboards)"
                  ...
                  />
                                ...
                                <CanteenForm value="water safety">
              <AccordianItem value="water safety" trigger="Water Quality & Maintenance">
                 <ChecklistSection
                    items={[
                    "Water clarity allows visibility of bottom",
                  "Chlorine/Bromine levels within safe range",
                  "pH levels within recommended range (7.2–7.8)",
                  "Skimmers and filters clean and operational",
                  "Regular backwashing and chemical logs maintained",
                  "No visible algae or debris in water"
                ...
                <AccordianItem value="changing rooms" trigger="Changing Rooms & Facilities">
                  <ChecklistSection
                    items={[
                    "Changing rooms/toilets clean and ventilated",
                  "Showers functional and clean",
                  "Floors dry or have anti-slip mats",
                  "Soap/hand sanitizer and toilet paper available"
                    ]}
                  />
                </AccordianItem>

                <AccordianItem value="personnel" trigger="Staff & Emergency Readiness">
                  <ChecklistSection
                    items={[
                   "Certified lifeguard(s) on duty during pool use",
                  "First aid kit fully stocked and accessible",
                  "Emergency procedures posted and understood by staff",
                  "Staff trained in CPR and emergency response",
                  "Logbook of water testing up to date"
